...
6.1.1 temai ir įterpia sugeneruotus HINTS + VARIANTS iš _data.js."""
import re, io
...
html = html.replace(
    ...
    "<title>Pabėgimas · Trupmenos, dešimtainiai, procentai · 6 klasė</title>")
...
html = html.replace(
    ...
    'Pabėgimo kambarys · Trupmenos, dešimtainiai, procentai · 6 klasė')
...
new_story = '''<div class="story">
      ...
      <p style="margin:12px 0 0"><i>„Kiekvienas seifo ratukas atsirakina teisingai pavertus trupmeną, dešimtainį
      skaičių ir procentus. Kiekvienas ratukas duoda po vieną seifo kodo skaitmenį. Surink visą kodą, atidaryk
      seifą ir dink.“</i></p>
...
html = html.replace("<b>🔒 10 grandinių.</b> Atrakinamos iš eilės, sprendžiant skliaustų lygtis.",
                    "<b>🔒 10 ratukų.</b> Atrakinami iš eilės pavertus trupmenas, dešimtainius ir procentus.")
...
html = html.replace(old_wintext,
    ...
    'Trupmenas, dešimtainius ir procentus verti akimirksniu, geriau nei bet kuris saugyklos sargas.</p>')
...
html = html.replace('rank="🔦 Ištrūkai, nors sargyba jau pabudo. Kitą kartą greičiau!"',
                    'rank="🔦 Ištrūkai, nors sargyba jau pabudo. Kitą kartą greičiau!"')
html = html.replace("skliaustus tu atskliaudi geriau nei bet kuris sargybinis.", "")  # jei liko sena frazė
