...
6.2.2 temai (procentų uždaviniai sudarant proporciją) ir įterpia sugeneruotus
HINTS + VARIANTS iš _data.js."""
import re, io
...
html = html.replace(
    ...
    "<title>Pabėgimas · Procentai per proporciją · 6 klasė</title>")
...
html = html.replace(
    ...
    'Pabėgimo kambarys · Procentų uždaviniai sudarant proporciją · 6 klasė')
...
new_story = '''<div class="story">
      ...
      <p style="margin:12px 0 0"><i>„Kiekvienas seifo ratukas atsirakina išsprendus procentų uždavinį. Sudaryk
      proporciją: 100 % atitinka visą dydį, p % atitinka ieškomą dalį x. Kiekvienas ratukas duoda po vieną seifo
      kodo skaitmenį. Surink visą kodą, atidaryk seifą ir dink.“</i></p>
...
html = html.replace("<b>🔒 10 grandinių.</b> Atrakinamos iš eilės, sprendžiant skliaustų lygtis.",
                    "<b>🔒 10 ratukų.</b> Atrakinami iš eilės sprendžiant procentų uždavinius sudarant proporciją.")
...
html = html.replace(old_wintext,
    ...
    'Procentų uždavinius sudarai proporcija ir sprendi akimirksniu, geriau nei bet kuris saugyklos sargas.</p>')
